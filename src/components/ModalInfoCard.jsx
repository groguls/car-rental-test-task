...
export const ModalInfoCard = (props) => {
  ...
  return (
    ...
    >
          ...
          >
            ...
            >
              {accessories.map((accessory) => (
                ...
                >
                  <Typography aria-label="accessories" sx={supportingTextStyle}>
                    {accessory}
                  </Typography>
                  <Divider />
                </Box>
      ...
      <CardActions disableSpacing={true} sx={{ padding: "0" }}>
        ...
        <MainButton href={`tel:${companyNumber}`} sx={mainButtonStyle}>
          Rental car
        </MainButton>
      </CardActions>
    </Card>
